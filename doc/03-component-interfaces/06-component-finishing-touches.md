...
I think I feel it is way more complicated than I thought before, writing pieces of the code is one thing, implementing it and connecting to the full thing, creating kernals and interfaces, connecting them is very important and I can see why people get paid a lot to do this. 
> Also, did the portfolio project surface any gaps in your own knowledge of
> software development. If so, what are those gaps and how did you address them?

I definetly had a lot of points where I was super lost and I had to ask for help or go through vscode tutorials to figure out things. Github was also a huge learning curve for me, I still don't fully understand what I was doing. I think at times I was just clicking buttons and hoping code committed and would be published. 
> Finally, as a part of completing the portfolio project, to what extent has
> your perspective of software development changed, if at all? In other words,
> is software development something you still enjoy? If not, why not?

It's very tedious, but I think the satisfaction of spending so much time on it an making it work is worth it. 
...
Github took a lot of time to figure out, I've used vscode before for python, but with Java it's significantly more complicated. 
...
I can tell it's going to be much more difficult than I expected when I first got interested in software, but I think now that I am already learning it I want to become very skilled with it and the benefits in the future for my career would be worth it.
> Finally, consider the skills you've picked up and your current career
> trajectory. What are some things you could do to continue on your
> career trajectory? Also, who are some mentors you could contact to help
> you stay on your path?

I will definetly continue practicing, understanding Java is pretty difficult at times, but there a lot more languages used in real life setting so over break I plan to do courses in others and get an AWS certification. Professor Griffski is a really great teacher I think because he understands really what students need, it made this class different from others I've taken, more enriching. I also would talk to my scholarship program director who is available to talk about career opprtunities. 
### Changelog
