...
### [2025.11.21]
- created tests for kernel and methods
- created sample code for a costellation maker and basic star catalog
- filled out componet finishing touches doc
- edited StarCatalog1 to add documentation 

### [2025.11.21]
- `StarCatalogSecondary` edited to fit implementation
-Updated StarCatalog Kernal
-Creared StarCatalog1
-Edited StarCatalog

### [2025.11.16]
- `StarCatalogSecondary` abstract class with full secondary implementation
-Updated StarCatalog Kernal
